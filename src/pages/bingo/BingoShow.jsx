...
export default function BingoShow() {
  ...
  return (
    <main className={`pro-stage pro-stage--${phase}`}>
      ...
      <section className={`pro-content ${premiosTV?.some((p) => p.active) ? "has-prizes" : ""}`}>
        <PremiosColumna premios={premiosTV} />
