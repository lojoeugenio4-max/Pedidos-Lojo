...
.cl-prize__copy p { margin:20px 0 0; padding:10px 14px; border-radius:12px; color:#7a1010; background:rgba(217,15,16,.08); border-left:5px solid #d90f10; font-size:clamp(18px,2vw,27px); font-weight:800; line-height:1.32; overflow-wrap:anywhere; }
...
.cl-prize--special { position:relative; border:4px solid #ffd34e; background:linear-gradient(145deg,#6a168f 0%,#a82572 42%,#d76a19 100%); box-shadow:0 0 0 3px rgba(255,211,78,.2),0 12px 30px rgba(0,0,0,.3),inset 0 0 24px rgba(255,255,255,.12); animation:cl-special-glow 2.4s ease-in-out infinite; }
...
.cl-prize--special .cl-prize__title { position:relative; color:#fff8c5; text-shadow:0 2px 4px rgba(0,0,0,.45); font-size:clamp(22px,2.4vw,36px); letter-spacing:.6px; font-weight:950; }
...
.cl-prize--special .cl-prize__copy p { color:#5c0e57; background:rgba(117,19,111,.1); border-left-color:#a82572; }
.cl-prize__badge { position:relative; z-index:1; width:max-content; max-width:calc(100% - 20px); margin:-2px auto 8px; padding:8px 22px; border:3px solid #fff0a4; border-radius:999px; color:#4f164f; background:linear-gradient(#ffe987,#ffc62d); box-shadow:0 6px 16px rgba(0,0,0,.35),0 0 0 5px rgba(255,198,45,.22); font-size:16px; font-weight:950; letter-spacing:2px; text-align:center; animation:cl-badge-pulse 1.6s ease-in-out infinite; }
@keyframes cl-special-glow { 0%,100% { box-shadow:0 0 0 3px rgba(255,211,78,.2),0 12px 30px rgba(0,0,0,.3),inset 0 0 24px rgba(255,255,255,.12); } 50% { box-shadow:0 0 0 6px rgba(255,211,78,.45),0 16px 40px rgba(0,0,0,.35),inset 0 0 32px rgba(255,255,255,.2); } }
@keyframes cl-badge-pulse { 0%,100% { transform:scale(1); } 50% { transform:scale(1.05); } }
