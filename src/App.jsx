...
export default function App() {
  ...
  // abierta en segundo plano (p.ej. para ir a WhatsApp) mientras el
  // almacén exporta el pedido, y volver después sin llegar a recargar la
  // página del todo — sin este efecto, el aviso de "todavía puedes
  // modificarlo" se quedaba anclado al estado que tenía la primera vez,
  // hasta cerrar y reabrir la app entera. Aquí solo se vigila la
  ...
  useEffect(() => {
    ...
    function alVolverVisible() {
      if (document.visibilityState === "visible") revisarSiSigueExportable();
    }
